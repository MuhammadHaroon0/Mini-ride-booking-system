        ...
        <div className="flex-1 px-8 py-16 bg-white">
          ...
          <form onSubmit={onSubmit}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link
                to={'/auth/signup'}
                className="shadow-xs bg-secondary border border-gray-300 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 shadow border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 flex-1"
              >
                Create Account
              </Link>
            </div>
